...
export default function PostsHome() {
    return (
        <main className="flex relative items-center justify-center min-h-[calc(100vh-5rem)] bg-gray-50 ">
            ...
            <div className="container mx-auto p-4 ">
                <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col justify-center">
                        ...
                        <Link href="#allPosts" className="outline  outline-offset-2 border-purple-700 text-purple-700 hover:text-white py-2 px-4 rounded hover:bg-purple-800 md:w-auto">
